...
public class Application {
		...
		while(true) {
			...
			switch (choice) {
				...
				case 6:
					...
					break;
				case 7:
					managerService.listAllActiveManagers();
					break;
				case 8:
					showDepartment(departmentService);
					break;
				case 9:
	...
	private static void showDepartment(DepartmentService departmentService) {

		List<Department> department =departmentService.allDepartmans();
		
		Iterator<Department> iterator1=department.iterator();
		while(iterator1.hasNext()) {
			Department depart=iterator1.next();
	...
	public static void listActiveManagers(ManagerService managerService) {
		...
		List<Manager> managerList = managerService.listAllActiveManagers();
	...
	public static void listDepartments(DepartmentService departmentService) {
		...
		List<Department> departmentList = departmentService.allDepartmans();
